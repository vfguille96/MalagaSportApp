...
public class ValorationRepository {
    ...
    private void inicializar() {
        try {
            ...
            add(new Valoration(1, "hola@gmail.com", MalagaSportApplication.DATE_FORMAT.parse("01/01/2019"), 3, "Instalaciones en condiciones deficientes, aunque el parque está bien :D"));
            ...
            add(new Valoration(2, "hola@gmail.com", MalagaSportApplication.DATE_FORMAT.parse("01/01/2019"), 4, "Todo perfecto."));
            ...
            add(new Valoration(4, "hola@gmail.com", MalagaSportApplication.DATE_FORMAT.parse("01/01/2019"), 5, "Instalaciones muy buenas y variadas."));
            ...
            add(new Valoration(3, "hola@gmail.com", MalagaSportApplication.DATE_FORMAT.parse("01/01/2019"), 3, "Instalaciones en condiciones deficientes, pero hay de todo."));
