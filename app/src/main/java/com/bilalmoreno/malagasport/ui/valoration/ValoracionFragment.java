...
public class ValoracionFragment extends BaseFragment implements ValorationContract.View, View.OnClickListener {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.menu_valoration, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_menu_valoration_delete:
                presenter.delete(valoration);
                break;
            default:
                return false;
        }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_valoracion, container, false);
        if (rootView != null) {
