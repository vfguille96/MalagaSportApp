...
public class ValorationPresenter implements ValorationContract.Presenter, ValorationInteractor.OnLoadFinishedListener, ValorationInteractor.ValorationInteractorListener {
    ...
    public ValorationPresenter(ValorationContract.View view) {
        this.view = view;
        interactor = new ValorationInteractor(this, this);
    }
